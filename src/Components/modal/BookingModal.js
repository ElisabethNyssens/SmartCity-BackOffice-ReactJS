...
import { getUsers, getLocations } from "../../api";

function BookingModal({ addFormData, handleAddFormChange, handleAddFormSubmit }) {
  ...
  const [newUserIsChecked, setNewUserIsChecked] = useState();
  const handleChangeUser = () => {
    setNewUserIsChecked(!newUserIsChecked);
  };

  const [newLocationIsChecked, setNewLocationIsChecked] = useState();
